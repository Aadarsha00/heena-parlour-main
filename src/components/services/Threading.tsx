...
const ServiceCard: React.FC<ServiceCardProps> = ({ service, index }) => (
  <div
    className="group relative bg-white/90 backdrop-blur-sm border border-black/5 rounded-3xl p-10 hover:bg-white transition-all duration-700 hover:shadow-2xl hover:shadow-black/10 hover:-translate-y-1"
